  ...
  describe('find winner', () => {
    ...
    test('example', () => {
      ...
      expect(game.winner.board).toStrictEqual([
        ...
        [{ 'marked': false, 'value': 10 }, { 'marked': false, 'value': 16 }, {
          'marked': false,
          'value': 15
        }, { 'marked': true, 'value': 9 }, { 'marked': false, 'value': 19 }],
        [{ 'marked': false, 'value': 18 }, { 'marked': false, 'value': 8 }, {
          'marked': true,
          'value': 23
        }, { 'marked': false, 'value': 26 }, { 'marked': false, 'value': 20 }],
        [{ 'marked': false, 'value': 22 }, { 'marked': true, 'value': 11 }, {
          'marked': false,
          'value': 13
        }, { 'marked': false, 'value': 6 }, { 'marked': true, 'value': 5 }],
        [{ 'marked': true, 'value': 2 }, { 'marked': true, 'value': 0 }, {
          'marked': false,
          'value': 12
        }, { 'marked': false, 'value': 3 }, { 'marked': true, 'value': 7 }]]);
    ...
    test('challenge', () => {
      ...
      expect(game.winner.board).toStrictEqual([
        [{ 'marked': true, 'value': 69 }, { 'marked': true, 'value': 29 }, {
          'marked': false,
          'value': 49
        }, { 'marked': false, 'value': 9 }, { 'marked': true, 'value': 76 }],
        [{ 'marked': true, 'value': 4 }, { 'marked': true, 'value': 83 }, {
          'marked': true,
          'value': 64
        }, { 'marked': true, 'value': 33 }, { 'marked': true, 'value': 2 }],
        [{ 'marked': false, 'value': 67 }, { 'marked': true, 'value': 81 }, {
          'marked': false,
          'value': 88
        }, { 'marked': false, 'value': 70 }, { 'marked': false, 'value': 39 }],
        [{ 'marked': false, 'value': 85 }, { 'marked': false, 'value': 73 }, {
          'marked': false,
          'value': 97
        }, { 'marked': true, 'value': 15 }, { 'marked': true, 'value': 8 }],
        [{ 'marked': false, 'value': 7 }, { 'marked': false, 'value': 13 }, {
          'marked': false,
          'value': 26
        }, { 'marked': true, 'value': 12 }, { 'marked': false, 'value': 1 }]
      ]);
